			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-12">
					...
					<p className="text-gray-600 dark:text-gray-400">
						Showcasing my work in artificial intelligence and
						machine learning
					</p>
				</div>
						...
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400 mb-4">
								<span className="font-semibold">
									Second project under my AltairX company
								</span>{" "}
								- A revolutionary AI-powered code editor that
								secured 10th position in the prestigious AIgnite
								competition.
							</p>
							<div className="flex flex-wrap gap-2 mb-4">
								<span className="px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded text-green-600 dark:text-green-400 text-xs font-medium">
									Founder
								</span>
								<span className="px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded text-green-600 dark:text-green-400 text-xs font-medium">
									AI
					...
					<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl border-2 border-green-500 dark:border-green-400 relative">
						...
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400 mb-4">
								...
								featuring an AI-powered career guidance system.
								Part of the broader AltairX ecosystem I
								developed.
							</p>
							<div className="flex flex-wrap gap-2 mb-4">
								<span className="px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded text-green-600 dark:text-green-400 text-xs font-medium">
					...
					<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl border-2 border-blue-500 dark:border-blue-400 relative">
						...
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400 mb-4">
								...
								- An innovative rental marketplace platform I
								conceptualized and pitched at Presidency
								University, receiving special recognition.
							</p>
							<div className="flex flex-wrap gap-2 mb-4">
								<span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/20 rounded text-blue-600 dark:text-blue-400 text-xs font-medium">
									Founder
								</span>
								<span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/20 rounded text-blue-600 dark:text-blue-400 text-xs font-medium">
									Startup
