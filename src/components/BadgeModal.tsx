			...
			<div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl max-w-md w-full mx-4 overflow-hidden relative z-10">
				...
				<div className="p-6">
					<p className="text-gray-600 dark:text-gray-400 mb-6">
						Thank you for visiting my profile! Here's your
						personalized badge as a token of appreciation.
					</p>
					...
					<div className="space-y-4">
						...
						<div className="mt-6">
							<h3 className="text-lg font-medium text-center text-gray-700 dark:text-gray-300 mb-4">
							...
							<div className="grid grid-cols-2 gap-4">
								{sharePlatforms.map((platform) => (
									...
									>
										<i
											className={`${platform.icon} text-lg mr-2`}
										/>
