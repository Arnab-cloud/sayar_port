			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-12">
					...
					<p className="text-gray-600 dark:text-gray-400">
						Interested in collaborating or have questions about my
						work?
					</p>
				</div>
										...
										<div className="space-y-6">
											...
											<div className="flex items-start space-x-4">
												...
												<div>
													...
													<a
														href="mailto:sayar.basu.cse26@heritageit.edu.in"
											...
											<div className="flex items-start space-x-4">
												...
												<div>
													...
													<div className="flex space-x-3 mt-2">
														<a
															href="https://github.com/Sayar-212"
															target="_blank"
															rel="noopener noreferrer"
															className="flex items-center justify-center h-8 w-8 rounded-full bg-white/20 text-white hover:bg-white/30 transition-colors"
														>
															<i className="ri-github-fill"></i>
														</a>
														<a
															href="https://www.linkedin.com/in/sayar-basu-21027b261/"
															target="_blank"
															rel="noopener noreferrer"
															className="flex items-center justify-center h-8 w-8 rounded-full bg-white/20 text-white hover:bg-white/30 transition-colors"
														>
