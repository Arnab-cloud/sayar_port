	...
	const renderProjectCard = (
		...
		return (
			<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl">
				<div
					className={`h-48 bg-gradient-to-r ${gradientFrom} ${gradientTo} flex items-center justify-center`}
				>
				...
				<div className="p-6">
					<div className="flex items-center justify-between mb-3">
						<span
							className={`px-3 py-1 ${categoryColor} rounded-full text-xs font-medium`}
						>
							{category}
						</span>
					...
					<div className="flex flex-wrap gap-2 mb-4">
						{tags.map((tag, index) => (
							<span
								key={index}
								className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-gray-600 dark:text-gray-400 text-xs"
							>
								{tag}
							</span>
						))}
							...
							<div className="absolute right-0 top-0 mt-6 mr-6">
								<div className="relative group">
									...
									<div className="absolute right-0 bottom-full mb-2 hidden group-hover:block w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg p-2 text-xs text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
										Sign in to view detailed project
										information
									</div>
								</div>
							</div>
					...
					<div className="container mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center mb-12">
							...
							<p className="text-gray-600 dark:text-gray-400">
								A comprehensive collection of my work in
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
									...
									<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
										...
										<div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/10 p-5 rounded-xl shadow-sm hover:shadow-md transition-all">
											...
											<p className="text-gray-600 dark:text-gray-400 text-sm mb-3">
												Developed an AI-powered
												educational platform with
												interactive learning tools and
											...
											<div className="flex flex-wrap gap-2 mb-3">
												{[
													...
													<span
														key={index}
														className="px-2 py-1 bg-orange-200/50 dark:bg-orange-800/30 rounded text-orange-700 dark:text-orange-300 text-xs font-medium"
													>
														{tag}
													</span>
												))}
										...
										<div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/10 p-5 rounded-xl shadow-sm hover:shadow-md transition-all">
											...
											<p className="text-gray-600 dark:text-gray-400 text-sm mb-3">
												...
												web platform with advanced data
											...
											<div className="flex flex-wrap gap-2 mb-3">
												{[
													...
													<span
														key={index}
														className="px-2 py-1 bg-red-200/50 dark:bg-red-800/30 rounded text-red-700 dark:text-red-300 text-xs font-medium"
													>
														{tag}
													</span>
												))}
										...
										<div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/10 p-5 rounded-xl shadow-sm hover:shadow-md transition-all">
											<div className="flex items-center mb-3">
												...
												<h3 className="text-lg font-bold text-gray-900 dark:text-white">
													Math Solver with Diagrams
												</h3>
											</div>
											<p className="text-gray-600 dark:text-gray-400 text-sm mb-3">
												Built a generative AI system
												that solves complex mathematical
												problems and generates
												explanatory diagrams for
											...
											<div className="flex flex-wrap gap-2 mb-3">
												{[
													...
													<span
														key={index}
														className="px-2 py-1 bg-purple-200/50 dark:bg-purple-800/30 rounded text-purple-700 dark:text-purple-300 text-xs font-medium"
													>
														{tag}
													</span>
												))}
								...
								<div className="p-6">
									...
									<p className="text-gray-600 dark:text-gray-400 mb-4">
										<span className="font-semibold">
											Second project under my AltairX
											company
										</span>{" "}
										- A revolutionary AI-powered code editor
										that secured 10th position in the
										prestigious AIgnite competition. One of
									...
									<div className="flex flex-wrap gap-2 mb-4">
										{[
											...
											<span
												key={index}
												className="px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded text-green-600 dark:text-green-400 text-xs font-medium"
											>
												{tag}
											</span>
										))}
							...
							<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl border-2 border-green-500 dark:border-green-400 relative">
								...
								<div className="p-6">
									...
									<h3 className="text-xl font-bold mb-2 text-green-600 dark:text-green-400">
										Altair - Career Guidance Bot
									</h3>
									<p className="text-gray-600 dark:text-gray-400 mb-4">
										<span className="font-semibold">
											My umbrella project
										</span>{" "}
										featuring an AI-powered career guidance
										system. Part of the broader AltairX
										ecosystem I developed. Currently runs on
										a local ngrok server when deployed.
									</p>
									<div className="flex flex-wrap gap-2 mb-4">
										{[
											"Owner",
									...
									<div className="flex flex-col space-y-2">
										...
										<div className="flex items-center mt-2 text-xs text-gray-500 dark:text-gray-400">
											...
											<span>
												Note: Demo requires ngrok server
												to be running
											</span>
										</div>
									</div>
							...
							<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl border-2 border-blue-500 dark:border-blue-400 relative">
								...
								<div className="p-6">
									...
									<p className="text-gray-600 dark:text-gray-400 mb-4">
										...
										- An innovative rental marketplace
										platform I conceptualized and pitched at
										Presidency University, receiving special
										recognition. Currently advancing from
										ideation to development phase.
									</p>
									<div className="flex flex-wrap gap-2 mb-4">
										{[
											"Founder",
											...
											<span
												key={index}
												className="px-2 py-1 bg-blue-50 dark:bg-blue-900/20 rounded text-blue-600 dark:text-blue-400 text-xs font-medium"
											>
												{tag}
											</span>
										))}
							...
							<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl relative">
								...
								<div className="p-6">
									...
									<p className="text-gray-600 dark:text-gray-400 mb-4">
										Completed multiple AI projects during my
										internship at Codsoft, demonstrating
										proficiency in machine learning, data
										analysis, and AI application
										development. Received official
										certification for the completed work.
									</p>
									<div className="flex flex-wrap gap-2 mb-4">
										{[
											"AI",
											...
											<span
												key={index}
												className="px-2 py-1 bg-amber-50 dark:bg-amber-900/20 rounded text-amber-700 dark:text-amber-400 text-xs"
											>
												{tag}
											</span>
										))}
							...
							<div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl">
								...
								<div className="p-6">
									...
									<p className="text-gray-600 dark:text-gray-400 mb-4">
										Sign Language Translator to Text and
										Speech and Reverse. 8th rank out of 20
										teams. Special Mention, State Winner @
										BIT Sindri Innovathon 2025.
									</p>
									<div className="flex flex-wrap gap-2 mb-4">
										{[
											"Computer Vision",
